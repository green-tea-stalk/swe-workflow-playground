...
| :--- | :--- | :--- | :--- | :--- |
| **REQ-001** | `COMP-101`, `COMP-103`, `COMP-104`, `COMP-202` | `TASK-001`, `TASK-004`, `TASK-006`, `TASK-008`, `TASK-009`, `TASK-010`, `TASK-011` | PR 1, PR 2, PR 3 | 未着手 (Pending) |
| **REQ-002** | `COMP-102`, `COMP-201` | `TASK-002`, `TASK-004`, `TASK-005`, `TASK-011` | PR 1, PR 2, PR 3 | 未着手 (Pending) |
| **REQ-003** | `COMP-101` | `TASK-006`, `TASK-011` | PR 2, PR 3 | 未着手 (Pending) |
| **REQ-004** | `COMP-102` | `TASK-005`, `TASK-011` | PR 2, PR 3 | 未着手 (Pending) |
| **REQ-005** | `COMP-102` | `TASK-005`, `TASK-011` | PR 2, PR 3 | 未着手 (Pending) |
| **REQ-006** | `COMP-102`, `COMP-103` | `TASK-005`, `TASK-008`, `TASK-011` | PR 2, PR 3 | 未着手 (Pending) |
| **REQ-007** | `COMP-103` | `TASK-008`, `TASK-011` | PR 3 | 未着手 (Pending) |
| **REQ-008** | `COMP-104`, `COMP-203`, `COMP-204` | `TASK-003`, `TASK-009`, `TASK-011` | PR 1, PR 3 | 未着手 (Pending) |
| **REQ-009** | `COMP-105`, `COMP-201`, `COMP-202`, `COMP-203`, `COMP-204` | `TASK-001`, `TASK-002`, `TASK-003`, `TASK-007`, `TASK-011` | PR 1, PR 2, PR 3 | 未着手 (Pending) |
| **REQ-010** | `COMP-201`, `COMP-202`, `COMP-203`, `COMP-204` | `TASK-001`, `TASK-002`, `TASK-003`, `TASK-011` | PR 1, PR 3 | 未着手 (Pending) |
| **REQ-011** | `COMP-103`, `COMP-104` | `TASK-008`, `TASK-009`, `TASK-011` | PR 3 | 未着手 (Pending) |
...
- [ ] **TASK-011**: 二言語検証用 Playwright E2E 自動テストスイートの構築
  ...
  - **受け入れ基準**:
    - [ ] シナリオ 1: 初回アクセスで言語検出（ブラウザ言語の一致）を検証すること。
    - [ ] シナリオ 2: ツールバーの言語切り替えで UI が切り替わり、日時フォーマットが変更され、`localStorage` に `bb_locale` が保存されることを検証すること。
    - [ ] シナリオ 3: フォームバリデーションエラーおよび送信フィードバックがアクティブな言語で表示されることを検証すること。
    - [ ] シナリオ 4: ユーザーが投稿したメッセージが両方のロケールで変更されずに表示されることを検証すること。
    - [ ] すべての Playwright E2E テストがヘッドレス Chromium で正常に合格すること。
